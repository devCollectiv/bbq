...
import { ColdLeadAttempt } from '../verification-questions-cold-lead/PreSignup'
...
const attemptSubmitted = (leadId: string, levelOfDifficulty: VerificationQuestionDifficultyEnum, slug: string, verificationQuestion: ColdLeadAttempt) => {
